...
​Hash Generator: Calculate various cryptographic hashes (MD5, SHA-256).
...
​Pixel to Rem/Em Converter: Easily convert pixel values to REM or EM units for responsive design.

​Box Shadow Generator: Visually design complex, beautiful CSS box-shadows and copy the code.
